...
For Stage A begin with `stage-a-2024-q1/STAGE_BRIEF.md`; for Stage B begin with `stage-b-2024-q2/STAGE_BRIEF.md`. Read thematic Parts and month reconstructions before register/chart/synthesis/review. Use each Stage handoff for bounded L3 transfer only.
