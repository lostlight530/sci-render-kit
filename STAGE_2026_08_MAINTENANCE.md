...
```text
Day 1
frontier positioning and scientific-communication layer clarification

Day 2
claim-to-visual bindings and process disclosure

Day 3 / 4
figure claim audit and evidence-plane separation
stable project identifiers without decorative versions

Day 5
assertion basis and dimensional communication coverage
...
```text
external research != scientific certification
adjacent plotting/research system != endorsement
new publication != reason to manufacture a new quality score
```
